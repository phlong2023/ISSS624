...
The R-Squared value can be calculated to evaluate the model.
...
The fitted values can be plotted against the actual values in order to roughly gauge the appropriateness of each model.
